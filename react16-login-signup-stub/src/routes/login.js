...
export class Login extends Component {
    ...
    onLogin(event) {
        ...
        if (this.state.email && this.state.password) {
            ...
            fetch(_BASE_URL + "users/login", obj)
                .then(responseCheck)
                .then(body => {
                    console.log(body);
                    history.push("home");
        ...
        return (
            <Grid container direction="column" alignItems="center" justify="center">
                <form className="display-contents">
                    ...
                    <Grid item><Typography variant="body1">Login</Typography></Grid>
                    <Grid item>
                    ...
                    <Grid item><Button type="submit" variant="contained" color="secondary" onClick={this.onLogin.bind(this)}>Login</Button>
                    </Grid>
                    <Grid item>
                    <Typography><Link to="/signup">Don't a account? Signup!</Link></Typography>
                    </Grid>
                </form>
            </Grid>
        )
